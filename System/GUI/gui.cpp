...
* 描述	    : 解析页面
*******************************************************************************/
void CSystem::Gui::Parse(Form * formPointer)
{  
...
*******************************************************************************/
void CSystem::Gui::InitForm(Form *formPointer)
{
...
*******************************************************************************/
void CSystem::Gui::AddLabel(Form * formPointer, Label *labelPointer)
{
...
*******************************************************************************/
void CSystem::Gui::AddTextBox(Form * formPointer, TextBox *textBoxPointer)
{    
    TextBox * pointer;
...
void CSystem::Gui::AddMessage(int id, int x, int y, char *fmt, ...)
{
    int len;
    va_list list;
...
void CSystem::Gui::DeleteMessage(int id)
{
...
*******************************************************************************/
void CSystem::Gui::SwitchTextBoxFocus(void)
{
...
*******************************************************************************/
void CSystem::Gui::ModifyTextBoxData(KeyEnum key)
{
    TextBox * textBoxPointer;
    void * dataPointer;
