...
* 输入参数  : 业务逻辑任务入口地址
*******************************************************************************/
void CSystem::OS::CreateLogicTask(function taskPointer)
{
    uint * sp;	
...
* 输入参数  : 菜单界面任务入口地址
*******************************************************************************/
void CSystem::OS::CreateMenuTask(function taskPointer)
{
    uint * sp;	
...
*******************************************************************************/
bool CSystem::OS::PostMessageQueue(uint message)
{	
    EnterCritical();
...
*******************************************************************************/
uint CSystem::OS::PendMessageQueue(void)
{
    uint message;
    EnterCritical();
...
*******************************************************************************/
void CSystem::OS::DelayMs(int times)
{
    if (times > 0) 
    {          
...
{    
    ...
    InitPsp((uint)LogicTaskStack + (sizeof LogicTaskStack) - 8 * 4);
}
